...
public class MailSender {
	...
	private static final Properties SMTP_PROFERTIES;
	
	static {
		
		SMTP_PROFERTIES = new Properties();
		SMTP_PROFERTIES.put("mail.smtp.host", "smtp.gmail.com");
		SMTP_PROFERTIES.put("mail.smtp.port", "587");
		SMTP_PROFERTIES.put("mail.smtp.starttls.enable", "true");
		SMTP_PROFERTIES.put("mail.smtp.ssl.protocols", "TLSv1.2");
		SMTP_PROFERTIES.put("mail.smtp.auth", "true");
		SMTP_PROFERTIES.put("mail.debug", "true");
	}

	//수신자, 메일 제목, 메일 내용(body)
	public void sendEmail(String to, String subject, String body) {

		Session session = Session.getInstance(SMTP_PROFERTIES, null);
	...
	private void sendMessage(Session session, MimeMessage msg) throws MessagingException {
		...
		tr.connect("smtp.gmail.com", Config.SMTP_AUTHENTICATION_ID.DESC, Config.SMTP_AHTHENTICATION_PASSWORD.DESC);
		msg.saveChanges();
