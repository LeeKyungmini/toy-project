...
public class HttpRequestTest extends HttpServlet {
	...
	private void testNaver() {
		...
		headers.put("X-Naver-Client-Id","skqqYyFSkUE8J5Q2knuI");
		headers.put("X-Naver-Client-Secret","K3PhrdDJpi");
	...
	private void testKakao() {
		...
		Map<String,String> headers = new HashMap<String, String>();
		headers.put("Authorization", "KakaoAK 4d83e941ac5ac28feba516d8510720c5");
